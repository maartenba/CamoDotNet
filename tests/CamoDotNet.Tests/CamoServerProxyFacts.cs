    ...
    : CamoServerFactsBase
{
    ...
    public async Task ProxiesValidUrl()
    {
        ...
        var response = await server.CreateClient().GetAsync(GenerateSignedUrl("https://raw.githubusercontent.com/NuGet/Home/dev/meta/resources/nuget.png"));
    ...
    {
        using var server = CreateServer();
        var response = await server.CreateClient().GetAsync(GenerateSignedUrl("https://www.github.com.thisdoesnotexist"));
